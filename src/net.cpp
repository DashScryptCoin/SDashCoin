...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DashScoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dashscryptcoin.selfip.com", "dashscryptcoin2.selfip.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"dashscointools.com", "testnet-seed.dashscointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DashScoin is probably already running."), addrBind.ToString().c_str());
        else
